const Skills = () => {
  const skills = [
    {
      title: "Languages",
      languages: ["TypeScript", "C#", "Python", "JavaScript", "Java", "Lua", "Dart", "Kotlin", "Swift" ],
    },
    { title: "Databases", languages: ["SQLite", "MMSQL", "Redis", "Oracle"] },
    {
      title: "Tools",
      languages: [
        "Figma",
    ...
    {
      title: "Other",
      languages: ["AWS", "SASS", "GCP", "Jenkins", "Linux", "Nginx","Node.js", "Tailwind", "Python"],
    },
    {
      title: "Frameworks",
      languages: [
      ...
      <div className="px-5 max-w-[1560px] mx-auto mt-20 py-10">
        ...
        <div data-aos = "fade-left" className=" mb-10">
          <div className=" text-white w-2/3 font-medium text-[32px] flex items-center gap-2">
            <div className="">
              <span className="text-[#51AAEE]">#</span> Skills
            </div>
